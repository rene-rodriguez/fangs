// =============================================================================
// Fangs Phase 0b spike — headless streaming AI in C (OpenAI-compatible)
// =============================================================================
...
//   Key:      env FANGS_API_KEY  (never hardcoded, never logged)
//
// Build: clang -O2 stream_test.c cJSON.c -lcurl -o stream_test
// Run:   FANGS_API_KEY=... ./stream_test
// =============================================================================
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int main(void) {
    ...
    if (!key || !*key) { fprintf(stderr, "ERROR: FANGS_API_KEY not set\n"); return 2; }
