// =============================================================================
// Nova Terminal Phase 0b spike — streaming AI into a Raylib window (worker thread)
// =============================================================================
...
// Run: NOVA_API_KEY=... ./stream_window
// =============================================================================
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int main(void) {
    if (!getenv("NOVA_API_KEY")) { fprintf(stderr, "ERROR: NOVA_API_KEY not set\n"); return 2; }
    ...
    InitWindow(W, H, "Nova Terminal — Phase 0b: streaming AI (worker thread + Raylib)");
    SetTargetFPS(60);
