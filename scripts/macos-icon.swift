// Generates the Fangs app icon (a dark terminal squircle with a green
// prompt chevron + cursor). Source of truth for assets/fangs.icns.
//
// Regenerate:
//   swift scripts/macos-icon.swift /tmp/fangs_1024.png
//   mkdir -p /tmp/fangs.iconset
//   for s in 16 32 128 256 512; do \
//     sips -z $s $s /tmp/fangs_1024.png --out /tmp/fangs.iconset/icon_${s}x${s}.png; \
//     d=$((s*2)); sips -z $d $d /tmp/fangs_1024.png --out /tmp/fangs.iconset/icon_${s}x${s}@2x.png; done
//   cp /tmp/fangs_1024.png /tmp/fangs.iconset/icon_512x512@2x.png
//   iconutil -c icns /tmp/fangs.iconset -o assets/fangs.icns
import AppKit
